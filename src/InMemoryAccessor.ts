import { ResourceIdentifier, Guarded, RepresentationMetadata, DataAccessor, NotFoundHttpError, guardedStreamFrom, IdentifierStrategy, InternalServerError, SingleThreaded } from '@solid/community-server';
...
interface DataEntry {
  ...
  export class InMemoryAccessor implements DataAccessor, SingleThreaded {
