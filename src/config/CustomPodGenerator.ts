...
import type { ResourceSet } from '@solid/community-server';
...
import { joinFilePath, isContainerIdentifier, resolveAssetPath } from '@solid/community-server';
import { addResourceMetadata } from '@solid/community-server';
import { guardedStreamFrom, readableToString } from '@solid/community-server';
import type { TemplateEngine } from '@solid/community-server';
import type { Resource, ResourcesGenerator } from '@solid/community-server';
 ...
 */
export class CustomPodGenerator implements ResourcesGenerator {
   ...
   */
  private async generateMetadata(metaLink: TemplateResourceLink, options: Dict<string>):Promise<RepresentationMetadata> {
